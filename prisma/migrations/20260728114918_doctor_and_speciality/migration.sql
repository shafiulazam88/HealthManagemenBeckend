...
-- CreateIndex
CREATE INDEX "idx_doctor_userId" ON "doctor"("email");
...
-- AddForeignKey
ALTER TABLE "doctor_specialities" ADD CONSTRAINT "doctor_specialities_specialityId_fkey" FOREIGN KEY ("specialityId") REFERENCES "Specilities"("id") ON DELETE CASCADE ON UPDATE CASCADE;
